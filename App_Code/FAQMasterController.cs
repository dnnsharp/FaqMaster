...
namespace avt.FAQMaster
{
    ...
    public class FAQMasterSettings
    {
        ...
        public string TemplatePath {
            get {
                return HttpContext.Current.Server.MapPath("~/DesktopModules/avt.FAQMaster/templates/"+ Template +"/");
            }
        }
    ...
    public class FAQMasterController : IPortable, ISearchable
    {
        ...
        //{
        //    return new AvtActivationDataSourceDb(DotNetNuke.Common.Utilities.Config.GetConnectionString(), _databaseOwner, _objectQualifier, "avtFAQMaster_Activations");
        //}
