<%@ Page Language="C#" AutoEventWireup="true" Inherits="avt.FAQMaster.ActivationWnd" EnableViewState = "true" CodeFile="Activation.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head>
    <title>FAQMaster Activation</title>
...
<div class = "act_wnd">
    ...
    <div class = "title">Activate FAQMaster</div>
    <div class = "help">
    ...
    <asp:Panel runat = "server" ID = "pnlSuccess" Visible = "false" style ="height: 290px; margin-top: 30px; padding-top: 30px;">
        ...
        <div style = "text-align: left">
            This copy of FAQMaster has been successfully activated.<br /><br />
            ...
            or the <a href = "<%= avt.FAQMaster.FAQMasterController.DocSrv%>">documentation server</a>.
            <br /><br /><br /><br /><br /><br />
        </div>
    </asp:Panel>
    ...
    <div style = "height: 320px; margin-top: 30px;" runat = "server" id = "pnlActivateForm">
        ...
        <div class = "instructions">
            ...
            If you don't have one yet, <a href = "<%= avt.FAQMaster.FAQMasterController.BuyLink %>">click here</a> to purchase a new license.
        </div>
