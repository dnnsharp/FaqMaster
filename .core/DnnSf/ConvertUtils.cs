...
namespace DnnSharp.FaqMaster.Core.DnnSf
{
    public static class ConvertUtils
    {
        ...
        public static T Cast<T>(object val, T defaultVal, bool throwIfNotConverted = true)
        {
            try {
            ...
            return (T)Cast(valstrl, typeof(T), defaultVal, throwIfNotConverted);

        }

        public static object Cast(string val, Type type, object defaultVal, bool throwIfNotConverted = true)
        {
            if (val == null)
            ...
            if (throwIfNotConverted)
                throw new ArgumentOutOfRangeException("Type " + type.ToString() + " is not supported!");
        ...
        public static string ToStringOrDefault(this Object value, string defaultVal = null)
        {
            if (value != null)
                return Convert.ToString(value);
        ...
        public static object To(this object obj, Type type)
        {
            ...
            if (obj.GetType() == type || obj.GetType() == u)
                return obj;

            // handle DateTime > DateTimeOffset
            if (u == typeof(DateTimeOffset) && obj.GetType() == typeof(DateTime)) {
                //return new DateTimeOffset((DateTime)obj);
                return DateTimeOffset.Parse(((DateTime)obj).ToString("o") + " +00:00");
            }
