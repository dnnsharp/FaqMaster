using DnnSharp.FaqMaster.Core.DnnSf.Crypt;
using System;
    ...
    public class LicenseInfo
    {
        ...
        public void Sign(string productKey)
        {
            ...
            if (ExpirationDate.HasValue)
                sbSign.Append(ExpirationDate.Value.ToString("o"));
        ...
        public void Save(string filePath)
        {
            ...
            using (var fs = File.OpenWrite(filePath)) {
                ...
                var writer = XmlWriter.Create(fs, settings); // new XmlTextWriter(fs, new UTF8Encoding(false));
        ...
        public bool SignCheck(string productKey)
        {
            ...
            if (ExpirationDate != null)
                sbVerify.Append(ExpirationDate.Value.ToString("o"));
